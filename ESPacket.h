...
#define ESPACKET_REQUEST_USERS 106 //all users in ExpenseShare world
...
#define ESPACKET_ADD_GROUP_MEMBER 204
#define ESPACKET_DELETE_OBJECT 205
#define ESPACKET_UPDATE_OBJECT 206
